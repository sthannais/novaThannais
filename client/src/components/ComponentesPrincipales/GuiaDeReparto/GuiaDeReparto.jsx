...
import CrearOrden from './ModalesAuxiliares/CrearOrden/CrearOrden';
import OrdenList from './OrdenList/OrdenList';
import DescargarOrden from './ModalesAuxiliares/DescargarOrden/DescargarOrden';
import ListaDePrecios from './ModalesAuxiliares/ListaDePrecios/ListaDePrecios';
import Patentes from './ModalesAuxiliares/Patentes/Patentes';
import Cuadrantes from './ModalesAuxiliares/Cuadrantes/Cuadrantes';
import style from './guiaDeReparto.module.css';
    ...
    return (
        <div>
            ...
            <div className={style.container}>
                ...
                <CrearOrden/>
                <DescargarOrden fecha={soloFecha}/>
