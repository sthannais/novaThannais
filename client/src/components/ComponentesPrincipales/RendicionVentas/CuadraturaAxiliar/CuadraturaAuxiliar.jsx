...
import { cuadrarOrdenAuxiliar, bringListaDePreciosActive } from '../../../../redux/novaSlice/thunks';
import style from './cuadraturaAuxiliar.module.css';
import cuadratura from '../../../../assetsOficial/cuadratura.svg';
import CambioDePersonal from '../../../ComponentesAuxiliares/CambioDePersonal/CambioDePersonal';
import Gastos from '../Cuadratura/Gastos/Gastos';
...
const CuadraturaAuxiliar = ({ novaOrdenById }) => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        dispatch(cuadrarOrdenAuxiliar(novaOrdenById.id, {
            ...efectivoNumber,
            ...vales,
            ...metodoPagosNumber,
            ...faltante,
...
export default CuadraturaAuxiliar
