...
import style from './rendicionVentas.module.css';
import JorgeGas from '../../../assetsOficial/jorgegas.svg';
import { BsFillCheckCircleFill } from 'react-icons/bs';
import { IoWarning } from 'react-icons/io5';
import TablePayment from './TablasDePago/TablaGeneral/TablaGeneral';
import TableEfectivo from './TablasDePago/TablaEfectivo/TablaEfectivo';
import TableVales from './TablasDePago/TablaVales/TablaVales';
...
const RendicionPage = () => { 
    ...
    return (
        <div className={style.conenedor}>
            <p className={style.text}>Rendición de ventas</p>
            ...
            <div className={style.container}>
                ...
                }
                {
                    ...
                    novaOrdenById?.rendida === true && email === 'maicol.nieto@jorgegas.cl' ||
