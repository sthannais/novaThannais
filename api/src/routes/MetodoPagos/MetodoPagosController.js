    ...
    try {
        ...
        const ordenesWithMetodoPagos = ordenes.map(orden => {
            return {
                ...
                valefisico5kg: orden.metodoPagos[0].vale.totalFisico5kg,
                valefisico11kg: orden.metodoPagos[0].vale.totalFisico11kg,
                valefisico15kg: orden.metodoPagos[0].vale.totalFisico15kg,
                valefisico45kg: orden.metodoPagos[0].vale.totalFisico45kg,
                valedigital5kg: orden.metodoPagos[0].vale.totalDigital5kg,
                valedigital11kg: orden.metodoPagos[0].vale.totalDigital11kg,
                valedigital15kg: orden.metodoPagos[0].vale.totalDigital15kg,
                valedigital45kg: orden.metodoPagos[0].vale.totalDigital45kg,
